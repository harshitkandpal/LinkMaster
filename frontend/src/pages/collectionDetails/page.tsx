...
export const CollectionDetails: React.FC = () => {
  ...
  return (
    <div className="md:container md:mx-auto px-4">
      <div className="font-bold lg:text-[5rem] sm:text-[3rem] text-[2rem]">
        {collection?.name}
      </div>
      <div className="lg:text-[1rem] sm:text-[0.875rem] text-[0.75rem]">
      ...
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="w-[100px] sm:text-[0.875rem] text-[0.75rem]">
              Title
            </TableHead>
